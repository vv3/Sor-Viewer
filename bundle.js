...
class BinReader {
    ...
    async readVal(length, type = "Int", position = this.cursor) {
        ...
        // Bug avoidance here.  Some SOR files causes overflow errors
        // Seems to only affect the very last data point
        // This is probably still a parsing bug, or a bogus SOR file
        if (end > this.data.byteLength) {
            // Let's simply return a dummy zero value
            return 0;
        }
...
},{"./binreader":1,"./cksum":2,"./points":8,"./proxy":9,"./unitmapping":12,"binary-file":14}],8:[function(require,module,exports){
const Cksum = require("./cksum");
...
},{"./cksum":2}],9:[function(require,module,exports){
...
},{"./cksum":2,"./datapts":3,"./fxdparams":4,"./genparams":5,"./keyevents":6,"./supparams":11}],10:[function(require,module,exports){
...
},{"./parser":7,"fs":18}],11:[function(require,module,exports){
class Supparam {
    constructor(name) {
        this.name = name;
        this.prefix = name.length + 1; // including \0
...
},{"./lib/sor.js":10,"_process":21}],14:[function(require,module,exports){
'use strict';
...
},{"./lib/binary-file":15}],15:[function(require,module,exports){
...
},{"buffer":19,"denodeify":16,"fs":18}],16:[function(require,module,exports){
